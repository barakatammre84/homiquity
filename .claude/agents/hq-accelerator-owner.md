...
description: Homiquity accelerator; use the current shared project instructions and applicable primary sources.
...
- `server/routes/borrower/realtorPrograms.ts`
- `client/src/pages/education/AcceleratorProgram.tsx`
- `client/src/pages/education/acceleratorProgram/`
